...
use songbird::input::{cached::Memory, Metadata};

use crate::services::polly::to_mp3;
...
async fn play(ctx: &Context, msg: &Message, args: Args) -> CommandResult {
    ...
    if let Some(handler_lock) = manager.get(guild_id) {
        ...
        let sound_data = to_mp3(ctx, args.rest()).await?;

        // let tmp_file = format!("/tmp/{}.mp3", msg.id.0);
        ...
        let source = songbird::input::Input::new(
            false,
            songbird::input::Reader::from_memory(sound_data),
